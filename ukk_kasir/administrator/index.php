			...
			<div class="col-sm-4">
				<div class="card">
					<div class="card-body">
						...
						<?php
						include '../koneksi.php';
						$data_produk = mysqli_query($koneksi,"SELECT * FROM produk WHERE ProdukID > 1;");
						$jumlah_produk = mysqli_num_rows($data_produk);
						?>
						<h3><?php echo $jumlah_produk; ?></h3>
						<a href="data_barang.php" class="btn btn-outline-info">Detail</a>
					</div>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="card">
					<div class="card-body">
						...
						<a href="pembelian.php" class="btn btn-outline-info">Detail</a>
					</div>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="card">
					<div class="card-body">
						...
						<a href="data_pengguna.php" class="btn btn-outline-info">Detail</a>
					</div>
				</div>
			</div>
		</div>
